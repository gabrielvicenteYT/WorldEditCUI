 ...
 */
public class FabricCUIConfigPanel extends Screen
{
	...
	private static final int EXTRA_CONTROLS_HEIGHT = FabricCUIConfigPanel.EXTRA_CONTROLS_SPACING * 2;
	...
	public FabricCUIConfigPanel()
	{
		this.mc = MinecraftClient.getMinecraft();
	}
	
	@Override
	public String getPanelTitle()
	{
		return I18n.translate("wecui.options.title");
	}
	
	@Override
	public int getContentHeight()
	{
		return this.colourButtonsBottom + FabricCUIConfigPanel.EXTRA_CONTROLS_HEIGHT + FabricCUIConfigPanel.CONTROLS_PADDING;
	}
	...
	public void onPanelShown(ConfigPanelHost host)
	{
		...
		{
			this.controlList.add(new GuiColourButton(this.mc, nextId, 24, FabricCUIConfigPanel.CONTROL_TOP + nextId * FabricCUIConfigPanel.CONTROL_SPACING, 40, 20, colour));
			this.controlList.add(new GuiControl(this.mc, FabricCUIConfigPanel.COLOUR_OPTION_BASE_ID + nextId, 234, FabricCUIConfigPanel.CONTROL_TOP + nextId * FabricCUIConfigPanel.CONTROL_SPACING, 60, 20, "Reset"));
			nextId++;
		}
		
		this.colourButtonsBottom = FabricCUIConfigPanel.CONTROL_TOP + nextId * FabricCUIConfigPanel.CONTROL_SPACING + FabricCUIConfigPanel.EXTRA_CONTROLS_SPACING;
		...
		this.controlList.add(this.chkClearAll = new GuiCheckbox(nextId, 24, this.colourButtonsBottom + FabricCUIConfigPanel.EXTRA_CONTROLS_SPACING, I18n.format("gui.options.extra.clearall")));
	...
	{
		this.drawString(this.mc.textRenderer, I18n.translate("gui.options.compat.title"),  10, FabricCUIConfigPanel.CONTROLS_PADDING, 0xFFFFFF55);
		this.drawString(this.mc.textRenderer, I18n.translate("gui.options.colours.title"), 10, 64, 0xFFFFFF55);
		this.drawString(this.mc.textRenderer, I18n.translate("gui.options.extra.title"), 10, this.colourButtonsBottom, 0xFFFFFF55);
	...
	private void actionPerformed(GuiButton control)
	{
		...
		if (control.id >= FabricCUIConfigPanel.COLOUR_OPTION_BASE_ID)
		{
			ConfiguredColour lineColour = ConfiguredColour.values()[control.id - FabricCUIConfigPanel.COLOUR_OPTION_BASE_ID];
