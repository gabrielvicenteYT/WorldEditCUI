...
public class GuiControl extends GuiButton
{
	...
	{
		this.drawControl(minecraft, mouseX, mouseY, 0.0F);
	}
	...
	/**
	 * GuiControlEx returns true from mousePressed if the mouse was captured, NOT if an action was performed. Containers
	 * should call this function afterwards to determine whether an action was performed.
	 * 
	...
	/**
	 * Draws a tesselated rectangle where the texture is stretched vertically and horizontally but the middle
	 * pixels are repeated whilst the joining pixels are stretched.
	 * 
	 * @param x Left edge X coordinate
	 * @param y Top edge Y coordinate
	 * @param x2 Right edge X coordinate
	...
	/**
	 * Draws a tesselated rectangle where the texture is stretched vertically and horizontally but the middle
	 * pixels are repeated whilst the joining pixels are stretched. Bordersize specifies the portion of the texture which
	 * will remain unstretched.
	 * 
	 * @param x Left edge X coordinate
	 * @param y Top edge Y coordinate
	 * @param x2 Right edge X coordinate
	 ...
	 * @param u2 Right edge U coordinate
	 * @param v2 Bottom edge V coordinate
	 * @param borderSize Number of pixels to leave unstretched, must be less than half of the width or height (whichever is smallest)
	 */
	...
	public static void drawStringWithEllipsis(FontRenderer fontrenderer, String s, int x, int y, int width, int colour)
	{
		...
		{
			fontrenderer.drawStringWithShadow(s, x, y, colour); // func_175063_a drawStringWithShadow
		}
		else if (width < 8)
		{
			fontrenderer.drawStringWithShadow("..", x, y, colour); // func_175063_a drawStringWithShadow
		}
		else
		{
			...
			fontrenderer.drawStringWithShadow(trimmedText + "...", x, y, colour); // func_175063_a drawStringWithShadow
		}
	}
